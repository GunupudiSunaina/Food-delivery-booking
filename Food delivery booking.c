...
//b->delivery_charge=50+((distance(f.restaurant,f.destination_point)-1)*5);
if(count==1)
{
...
void food_delivery(int DE)
{
 ...
 printf("\n   DE1                   %d",delivery_charge[0]);
 printf("\n   DE2                   %d",delivery_charge[1]);
 printf("\n   DE3                   %d",delivery_charge[2]);
 printf("\n   DE4                   %d",delivery_charge[3]);
 printf("\n   DE5                   %d",delivery_charge[4]);
 printf("\nAllotted Delivery  Executive:%d",b[0][i].customer_id);
}
void display()
{
// printf("%d %d %d %d",DE1_book,DE2_book,DE3_book,DE4_book,DE5_book);
 if(DE1_book>0)
 {
 	printf("\nDE 1 \n total Earning= %d\n",delivery_charge[0]);printf("\nDE 1 \n total Earning= %d\n",delivery_charge[0]);
